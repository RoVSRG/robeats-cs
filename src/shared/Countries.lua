...
for _, country in countryList do
    table.insert(Countries.CountryNames, country)
end

table.sort(Countries.CountryCodes, function(a, b)
    return a < b
end)

table.sort(Countries.CountryNames, function(a, b)
    return a < b
end)
...
function Countries:get_country_name_from_code(code)
