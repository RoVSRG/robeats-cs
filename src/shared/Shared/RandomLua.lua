...
function twister(s)
	...
	function temp:rand_rangei(min,max)
		return math.floor((temp:random(0) / 65536) * (max - min)) + min
	end		
	
	function temp:rand_rangef(min,max)
		return (temp:random(0) / 65536) * (max - min) + min
	end		
